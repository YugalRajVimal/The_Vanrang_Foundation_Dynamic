          ...
          <div className="w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                href="/donate"
                className={`
                  bg-secondary hover:bg-secondary-dark text-white px-6 xs:px-8 py-2.5 xs:py-3 rounded-lg
                  font-semibold transition-colors shadow-lg inline-block text-center text-base xs:text-lg w-full sm:w-auto
                  focus:outline-none focus:ring-2 focus:ring-secondary-dark focus:ring-opacity-70
                `}
                onClick={handleVolunteerClick}
                style={{
                  letterSpacing: "0.5px",
