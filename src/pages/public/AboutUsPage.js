    ...
    <section className="pt-20 min-h-[100vh]" style={{ backgroundColor: COLORS.background, color: COLORS.textPrimary }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="/donate" className="inline-block px-6 py-3 rounded-lg font-semibold shadow-lg transition text-base"
              style={{ background: COLORS.secondary, color: "#fff", letterSpacing: "0.03em", boxShadow: `0px 2px 18px 0px ${COLORS.surfaceShadow}`, border: `2px solid ${COLORS.secondary}` }}
              onClick={scrollToTop}>
              Donate Now
            </a>
            <a href="/contact" className="inline-block px-6 py-3 rounded-lg font-semibold shadow-lg transition text-base"
